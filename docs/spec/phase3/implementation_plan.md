...
- optional smoke で `AssessMeister` の `ShellViewModel` system pack を検証する
...
- `AssessMeister` の `ShellViewModel` pack で `Shell + Drafting + Settings/Report + Architecture` が読める
