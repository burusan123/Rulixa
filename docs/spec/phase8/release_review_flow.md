...
2. `summary.md`
3. `release-review.md`
4. `human-outputs/*-<synthetic-root-case>.md`
7. `kpi.json`
8. compare-evidence が必要な場合のみ追加確認
...
- GitHub Actions の step summary から `summary.md` と `release-review.md` の両方を追える
- synthetic root cases の human outputs が毎回生成される
- observed corpus の human outputs は optional smoke 実行時のみ加算される
