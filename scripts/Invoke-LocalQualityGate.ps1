...
try {
    ...
    Invoke-DotNet -Arguments @(
        ...
        '--no-build',
        '--filter',
        'FullyQualifiedName~CompareEvidenceBundleTests|FullyQualifiedName~LocalQualityGateRunWriterTests|FullyQualifiedName~ReleaseReviewArtifactWriterTests|FullyQualifiedName~QualityHandoffOutcomeEvaluatorTests|FullyQualifiedName~PublicDocsHardeningTests')
    Invoke-DotNet -Arguments @(
        'test',
